...
if evals_only
   ...
   if (N/size(x, 2)) > 0.04 %This ratio is rather ad hoc. Given d/q as a constant, I find that the ratio should be a 
       %increasing function of d and thus I suggest trying respectively eig
       %and eigs with your data to be fitted and then determine the better one.
